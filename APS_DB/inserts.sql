...
INSERT INTO frete(`idPessoaRemetente`,`idPessoaDestinario`,`idPessoaTomador`,`idPessoaMotorista`,`NumeroCTe`,`DataEmissao`,`DataEntrega`,`VlCarga`,`VlPedagio`,`VlFrete`,`PesoBruto`,`Finalizado`)values
...
insert into frete_veiculo (`idFrete`,`idVeiculo`) values
(1,1),
(1,4),
(2,2),
(2,5),
