...
CREATE TABLE IF NOT EXISTS `mydb`.`Pais` (
  ...
  UNIQUE INDEX `idPais_UNIQUE` (`id` ASC))
ENGINE = InnoDB;
...
INSERT INTO `estado` (`id`, `nome`, `sigla`, `pais`) VALUES
(1, 'Acre', 'AC', 1),
(2, 'Alagoas', 'AL', 1),
(3, 'Amazonas', 'AM', 1),
(4, 'Amapá', 'AP', 1),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Frete` (
  ...
  INDEX `fk_Frete_Pessoa2_idx` (`idPessoaDestinario` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Modelo` (
  ...
  CONSTRAINT `fk_Modelo_TipoVeiculo1`
    ...
    REFERENCES `mydb`.`TipoVeiculo` (`idTipoVeiculo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Frete_Veiculo` (
  `Frete_idFrete` INT NOT NULL,
  `Veiculo_idVeiculo` INT NOT NULL,
  INDEX `fk_Frete_Veiculo_Frete1_idx` (`Frete_idFrete` ASC),
  INDEX `fk_Frete_Veiculo_Veiculo1_idx` (`Veiculo_idVeiculo` ASC),
  CONSTRAINT `fk_Frete_Veiculo_Frete1`
    FOREIGN KEY (`Frete_idFrete`)
    REFERENCES `mydb`.`Frete` (`idFrete`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Frete_Veiculo_Veiculo1`
